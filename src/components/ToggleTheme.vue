...
function setTheme(toDark = false) {
  document.querySelector('html')?.setAttribute('data-theme', toDark ? 'dark' : 'light')
}
...
<template>
  <label class="swap swap-rotate" :title="isDark ? '切换到浅色主题' : '切换到深色主题'">
